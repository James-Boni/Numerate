...
export default function DoublingGame() {
  ...
  const endSession = () => {
    ...
    const xpEarned = finalCorrect * 4 + (finalBestStreak >= 5 ? 30 : 0);
    
    const fluencyMetrics = computeFluency(finalTotal, finalCorrect, selectedDuration, times);
    
    const isNewBest = finalCorrect > skillDrillBests.doubling.bestScore;
    ...
    updateSkillDrillBests('doubling', finalCorrect, finalBestStreak);
